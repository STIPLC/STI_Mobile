...
// Personal Details Prefs
    ...
    public String getUsername() {
        return sharedPreferences.getString(Constant.USER_USERNAME, "");
    }

    public void setBio(String Bio) {
        editor.putString(Constant.BIO, Bio);
        editor.apply();
    }
    ...
    public void setProfileImg(String ProfileImg) {
        editor.putString(Constant.USER_PROFILE_IMAGE_URL, ProfileImg);
        editor.apply();
    }

    public String getProfileImg() {
        return sharedPreferences.getString(Constant.USER_PROFILE_IMAGE_URL, "");
    }

    public void setPhoneNUM(String PhoneNUM) {
        editor.putString(Constant.USER_PHONE_NUM, PhoneNUM);
        editor.apply();
    }

    public String getPhoneNUM() {
        return sharedPreferences.getString(Constant.USER_PHONE_NUM, "");
    }
    ...
    public void setFirstName(String FirstName) {
        editor.putString(Constant.USER_FIRSTNAME, FirstName);
        editor.apply();
    }

    public String getFirstName() {
        return sharedPreferences.getString(Constant.USER_FIRSTNAME, "");
    }

    public void setLastName(String LastName) {
        editor.putString(Constant.USER_LASTNAME, LastName);
        editor.apply();
    }

    public String getLastName() {
        return sharedPreferences.getString(Constant.USER_LASTNAME, "");
    }
